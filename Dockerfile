...
COPY src /usr/src/delft/
WORKDIR /usr/src/delft
...
RUN chmod +x /usr/src/delft/tasks.py \
    && chmod +x /usr/src/delft/entrypoint.sh
...
# ENTRYPOINT /usr/src/delft/entrypoint.sh
